...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-acbad5","is-html-acbad5","is-jsdelivr-acbad5","is-gtm-acbad5","is-gravatar-acbad5","is-theme-acbad5","is-json-acbad5"];
      return Promise.all(
        names
